...
| M2T| Owner-cloud credential alignment + M2 deploy | all M2 packets DONE  | TODO        |                              | F016 RESOLVED (D.2 096); charge EXPANDED 2026-08-06: alignment wired into deploy + v2.50 update prompt in up — the one-step update |
