...
| M2T| Owner-cloud credential alignment + M2 deploy | all M2 packets DONE  | TODO        |                              | F016 RESOLVED (D.2 096): fresh grant, corrected reset, fresh receipt per attempt; resume per report 062 |
